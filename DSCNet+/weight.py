...
def update_predict(model):
    ...
    state_dict = torch.load('/home/hemraj/Downloads/BDCNet/pretrain/2021-ICCV-FSNet_flow-20epoch-new.pth')
    ...
    # ---- copy model-a to model-b ----
    model_dict = model.state_dict()  # copy base models to the object models
    state_dict = torch.load('/home/hemraj/Downloads/BDCNet/pretrain/2021-ICCV-FSNet_rgb-20epoch-new.pth')
